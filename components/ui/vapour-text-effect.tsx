    ...
    const animate = (currentTime: number) => {
      ...
      switch (animationState) {
        ...
        case "vaporizing": {
          ...
          // Check if vaporization is complete (with safety fallback)
          if ((vaporizeProgressRef.current >= 100 && allVaporized) || vaporizeProgressRef.current >= 160) {
