...
class Config:
    ...
    # Mot de passe admin haché bcrypt pour la démonstration (admin)
    ADMIN_PASSWORD_HASH = b'$2b$12$Z/W.rG3/62C.D/Q2y.A...sKkE.O3SgH/w4c/s3K5.X9O.m.rO.' # bcrypt 'admin' (on le regénère dans l'init si besoin)
